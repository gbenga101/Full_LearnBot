...
def simplify():
    try:
        ...
        if simplified and isinstance(simplified, str) and simplified.strip():
...
# NOT SURE IF IT'S WORKING (MUST TEST LATER THOUGH)
""" # routes/api.py
import logging
from flask import Blueprint, request, jsonify
import hashlib, os, time
...
from services.openai_api import OpenAISimplifier
from services.openrouter_api import HFSimplifier
